...
class HomeListAPIView(APIView):
    ...
    permission_classes = [
        IsAuthenticated
    ]  # Ensures only authenticated users can access this API
...
class RegisterAPIView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if email_verification_code is False:
            ...
            return render(request, "register.html", context)
        context["success"] = (
            "User has created successfully and verification code has send your mail."
        )
...
class OTPVerifyAPIView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            context["error"] = (
                "Unable to find user with email.Go to register page and register  again."
            )
            return render(request, "verify_otp.html", context)
        ...
        member.save()
        context["success"] = (
            "Account activated successfully,please login to your account."
        )
        del request.session["email"]
        return render(request, "login.html", context)
...
class VerifyMailLinkAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            context["error"] = (
                f"Unable to retrive mail from session or user has been already verified and active : {str(e)}"
            )
        ...
        try:
            ...
            context["error"] = (
                "Unable to find user with email.Go to register page and register  again or contact  us for help."
            )
            return render(request, "login.html", context)
        ...
        if user.is_active is True and member.is_active is True:
            context["error"] = (
                "User is already active and verified,please login to your account."
            )
        ...
        context["success"] = (
            "Your mail is verified successfully,please login to your account."
        )
        return render(request, "login.html", context)
...
class ResendVerificationAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            context["error"] = (
                "User does not exist with user and enter a correct mail id associated with user"
            )
            context["mail"] = "Required"
            return render(request, "verify_otp.html", context)
        ...
        email_verification_code = verify_user(
            identifier=verification_identifier, data=data
        )
        if email_verification_code is False:
